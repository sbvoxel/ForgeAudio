...
#define SBAUDIO_ABI_VERSION     0
#define SBAUDIO_MAJOR_VERSION     0
#define SBAUDIO_MINOR_VERSION     1
#define SBAUDIO_PATCH_VERSION     0

#define SBAUDIO_COMPILED_VERSION ( \
    (SBAUDIO_ABI_VERSION * 100 * 100 * 100) + \
    (SBAUDIO_MAJOR_VERSION * 100 * 100) + \
    (SBAUDIO_MINOR_VERSION * 100) + \
    (SBAUDIO_PATCH_VERSION) \
)

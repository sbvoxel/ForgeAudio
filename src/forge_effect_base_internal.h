...
FORGE_INTERNAL_API void forge_effect_base_init(
    ForgeEffectBase *effect,
    const ForgeEffectInfo *effect_info,
    uint8_t *parameters,
    uint32_t parameter_block_byte_size
...
FORGE_INTERNAL_API void forge_effect_base_init_with_allocator(
    ForgeEffectBase *effect,
    const ForgeEffectInfo *effect_info,
    uint8_t *parameters,
    uint32_t parameter_block_byte_size,
...
FORGE_INTERNAL_API void forge_effect_base_get_info(
    ForgeEffectBase *effect,
...
FORGE_INTERNAL_API ForgeResult forge_effect_base_initialize(
    ForgeEffectBase *effect,
    const void* data,
...
FORGE_INTERNAL_API uint32_t forge_effect_base_calc_input_frames(
    ForgeEffectBase *effect,
    uint32_t output_frame_count
);

FORGE_INTERNAL_API uint32_t forge_effect_base_calc_output_frames(
    ForgeEffectBase *effect,
    uint32_t input_frame_count
);

FORGE_INTERNAL_API ForgeResult forge_effect_base_validate_default_format(
    ForgeEffectBase *effect,
    ForgeAudioFormat *format,
    uint8_t overwrite
);

FORGE_INTERNAL_API ForgeResult forge_effect_base_validate_format_pair(
    ForgeEffectBase *effect,
...
FORGE_INTERNAL_API void forge_effect_base_process_through(
    ForgeEffectBase *effect,
    void* input_buffer,
    float *output_buffer,
...
FORGE_INTERNAL_API void forge_effect_base_set_parameters(
    ForgeEffectBase *effect,
    const void* parameters,
    uint32_t parameter_byte_size
);

FORGE_INTERNAL_API void forge_effect_base_get_parameters(
    ForgeEffectBase *effect,
    void* parameters,
    uint32_t parameter_byte_size
);

FORGE_INTERNAL_API void forge_effect_base_on_set_parameters(
    ForgeEffectBase *effect,
    const void* parameters,
    uint32_t parametersSize
);

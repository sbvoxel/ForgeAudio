...
FORGE_INTERNAL_API void forge_platform_init(ForgeAudioEngine *audio, uint32_t flags, uint32_t device_index,
                                            ForgeAudioFormatExtensible *mix_format, uint32_t *update_size,
                                            void **platform_device);
FORGE_INTERNAL_API void forge_platform_quit(void *platform_device);

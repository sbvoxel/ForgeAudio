...
FORGE_INTERNAL_API void fa_effect_base_destroy(ForgeEffectBase *effect);

FORGE_INTERNAL_API void fa_effect_base_get_info(ForgeEffectBase *effect, ForgeEffectInfo *effect_info);

FORGE_INTERNAL_API ForgeResult fa_effect_base_is_input_format_supported(ForgeEffectBase *effect,
                                                                        const ForgeAudioFormat *output_format,
                                                                        const ForgeAudioFormat *requested_input_format,
                                                                        ForgeAudioFormat **supported_input_format);

FORGE_INTERNAL_API ForgeResult fa_effect_base_is_output_format_supported(
...
FORGE_INTERNAL_API ForgeResult fa_effect_base_initialize(ForgeEffectBase *effect, const void *data,
                                                         uint32_t data_byte_size);

FORGE_INTERNAL_API void fa_effect_base_reset(ForgeEffectBase *effect);

FORGE_INTERNAL_API ForgeResult fa_effect_base_lock_for_process(ForgeEffectBase *effect,
...
FORGE_INTERNAL_API void fa_effect_base_unlock_for_process(ForgeEffectBase *effect);

FORGE_INTERNAL_API uint32_t fa_effect_base_calc_input_frames(ForgeEffectBase *effect, uint32_t output_frame_count);

FORGE_INTERNAL_API uint32_t fa_effect_base_calc_output_frames(ForgeEffectBase *effect, uint32_t input_frame_count);

FORGE_INTERNAL_API ForgeResult fa_effect_base_validate_default_format(ForgeEffectBase *effect, ForgeAudioFormat *format,
                                                                      uint8_t overwrite);

FORGE_INTERNAL_API ForgeResult fa_effect_base_validate_format_pair(ForgeEffectBase *effect,
                                                                   const ForgeAudioFormat *supported_format,
                                                                   ForgeAudioFormat *requested_format,
                                                                   uint8_t overwrite);

FORGE_INTERNAL_API void fa_effect_base_process_through(ForgeEffectBase *effect, void *input_buffer,
...
FORGE_INTERNAL_API void fa_effect_base_set_parameters(ForgeEffectBase *effect, const void *parameters,
                                                      uint32_t parameter_byte_size);

FORGE_INTERNAL_API void fa_effect_base_get_parameters(ForgeEffectBase *effect, void *parameters,
                                                      uint32_t parameter_byte_size);

FORGE_INTERNAL_API void fa_effect_base_on_set_parameters(ForgeEffectBase *effect, const void *parameters,
                                                         uint32_t parametersSize);

FORGE_INTERNAL_API uint8_t fa_effect_base_parameters_changed(ForgeEffectBase *effect);

FORGE_INTERNAL_API uint8_t *fa_effect_base_begin_process(ForgeEffectBase *effect);

FORGE_INTERNAL_API void fa_effect_base_end_process(ForgeEffectBase *effect);

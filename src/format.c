...
MAKE_FORMAT_ID(xmaudio2, FA_AUDIO_FORMAT_XMAUDIO2);
MAKE_FORMAT_ID(wmaudio2, FA_AUDIO_FORMAT_WMAUDIO2);
MAKE_FORMAT_ID(wmaudio3, FA_AUDIO_FORMAT_WMAUDIO3);
MAKE_FORMAT_ID(wmaudio_lossless, FA_AUDIO_FORMAT_WMAUDIO_LOSSLESS);
